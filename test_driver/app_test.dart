...
//import 'package:flutter_test/flutter_test.dart' as find;
import 'package:ChatUI/user/widgets/auth_login.dart';
import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  group('ChatUI App', () async{
    ...
    // final counterTextFinder = find.byKey(ValueKey("AddmIN"));
   ...
   // FlutterDriver driver;
    ...
    //  await driver.tap(addEmail);
      await driver.enterText("tadas1@gmail.com");

    //  await driver.tap(addPassword);
      await driver.enterText("123456");

   //   await driver.tap(addLogin);
    //  await driver.waitFor(find.text("Your Todos"));
    });
